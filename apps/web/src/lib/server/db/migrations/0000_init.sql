...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "hold_expire_idx" ON "bookings" USING btree ("hold_expires_at");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "idemp_unique_idx" ON "idempotency_keys" USING btree ("scope","key");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "invoice_number_uk" ON "invoices" USING btree ("number");--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "route_start_at_idx" ON "slots" USING btree ("route_id","start_at");--> statement-breakpoint
DO $$ BEGIN
