...
- **Контракты в первую очередь (Contract-First)**: Взаимодействие между слоями (UI, BFF, сервисы) строго типипизировано через общие TypeScript-интерфейсы.
...
- **Версионирование**: Любое изменение в документации (файлы в `/docs`) должно сопровождаться обновлением номера версии в заголовке документа. Это обеспечивает контроль актуальности.
